Function New-LaunchScriptAHL2serverPS {
  ...
  $global:launchParams    = '@("${executable} -console -game ahl2 -strictportbind -ip ${ip} -port ${port} +hostname `"${hostname}`" +clientport ${clientport} +tv_port ${sourcetvport} +map ${defaultmap} +servercfgfile ${servercfg} -maxplayers ${maxplayers} -condebug")'
